...
export type BossSupportTargetType =
...
export interface BossSupportTarget {
  id: string;
  x: number;
  y: number;
  type: BossSupportTargetType;
  createdAt: number;
  lifespan: number;
  points: number;
  hp: number;
...
export interface BossTickResult {
  ...
  spawnTargets: BossSupportTarget[];
...
function makeSupportTarget(type: BossSupportTargetType, bossX: number, bossY: number): BossSupportTarget {
  bossTargetIdCounter++;
...
export function tickBoss(boss: BossState, activeSupportCount: number): BossTickResult {
  ...
  const spawnTargets: BossSupportTarget[] = [];
