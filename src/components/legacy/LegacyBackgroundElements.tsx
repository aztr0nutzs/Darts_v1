...
/**
 * LEGACY / QUARANTINED VISUALS
 *
 * These components are intentionally isolated from the active gameplay stack.
 * They represent pre-redesign neon/cyber background language that conflicts
 * with the current black-first direction.
 *
 * Do NOT reintroduce these into active screens without explicit design review.
 * Keep this file as a quarantine zone for historical reference only.
 */
